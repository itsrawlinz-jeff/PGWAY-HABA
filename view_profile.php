...
$row=mysqli_fetch_assoc($result);
	...
	$fname=isset($row['firstname']);
	$lname=isset($row['lastname']);
	$sex=isset($row['sex']);
	$email=isset ($row['email']) ;
	$dob=isset($row['dateofbirth']);  
	$religion=isset($row['religion']);
	$caste =isset($row['caste']) ;
	$subcaste=isset($row['subcaste']);
	$country = isset($row['country']) ;
	$state=isset($row['state']);
	$district= isset($row['district']);
	$age=isset($row['age']);
	$maritalstatus= isset($row['maritalstatus']);
	$profileby=isset($row['profilecreatedby']);
	$education=isset($row['education']);
	$edudescr=isset($row['education_sub']);
	$bodytype=isset($row['body_type']);
	$physicalstatus=isset($row['physical_status']);
	$drink=isset($row['drink']);
	$smoke=isset($row['smoke']);
	$mothertounge=isset($row['mothertounge']);
	$bloodgroup=isset($row['blood_group']);
	$weight=isset($row['weight']);
	$height=isset($row['height']);
	$colour=isset($row['colour']);
	$diet=isset($row['diet']);
	$occupation=isset($row['occupation']);
	$occupationdescr=isset($row['occupation_descr']);
	$fatheroccupation=isset($row['fathers_occupation']);
	$motheroccupation=isset($row['mothers_occupation']);
	$income=isset($row['annual_income']);
	$bros=isset($row['no_bro']);
	$sis=isset($row['no_sis']);
	$aboutme=isset($row['aboutme']);
...
if($result2){
	...
	$pic1=isset($row2['pic1']);  
	$pic2=isset($row2['pic2']);
	$pic3=isset($row2['pic3']);
	$pic4=isset($row2['pic4']);
}
}else{
...
$agemin=isset($row['agemin']);
$agemax=isset($row['agemax']);
$maritalstatus=isset($row['maritalstatus']);
$complexion=isset($row['complexion']);
$height=isset($row['height']);
$diet=isset($row['diet']);
$religion=isset($row['religion']);
$caste=isset($row['caste']);
$mothertounge=isset($row['mothertongue']);
$education=isset($row['education']);
$occupation=isset($row['occupation']);
$country=isset($row['country']);
$descr=isset($row['descr']);

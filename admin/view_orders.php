...
<i class="fa fa-dashboard"></i> Dashboard / Match Requests
...
<i class="fa fa-money fa-fw"></i> View Match Requests
...
$get_customer_order = "select * from match where order_id='$order_id'";
